    ...
    <div className="w-full h-full">
      <Canvas
        ...
        onCreated={({ gl }) => {
          ...
          // Type-safe approach: attach data attributes directly onto the raw canvas element 
          // instead of breaking properties inside standard React-Three-Fiber component types
...
function Band({
  ...
  // Keep the raw canvas DOM node updated in sync with live frame ticks 
  useFrame((state, delta) => {
